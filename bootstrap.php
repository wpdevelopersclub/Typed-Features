 ...
 *
 * @wordpress-plugin
 * Plugin Name:     Typed Features Plugin
 * Plugin URI:      https://UpTechLabs.io
 * Description:     Type out the messages for a newsfeed style container.
 * Version:         1.2.0
 * Author:          hellofromTonya
 * Author URI:      https://UpTechLabs.io
 * Text Domain:     typed_features
 * Requires WP:     4.5
 * Requires PHP:    5.4
 */
...
fulcrum_declare_plugin_constants( 'TYPED_FEATURES', __FILE__ );
...
function launch( Fulcrum_Contract $fulcrum ) {
	...
	$fulcrum['typed_features'] = $instance = new Plugin(
		new Config( $path ),
		__FILE__,
		$fulcrum
	);
